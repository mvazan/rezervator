...
- `supabase/tests/tenancy_rls.sql` — cross-tenant isolation, superadmin
  ...
  name/colour copied and propagated, a grouped date blocks like a lone
  rental, the group vanishes with its last date, invisible across tenants,
  full-DML privileges), and the 0035
