...
/// resolved tap handler (or null to render the cell inert). Shared by
/// [WeekListView] (compact tiles) and [DayPagerView] (large tiles) so the
/// policy has exactly one implementation regardless of layout.
Widget slotTileFor({
